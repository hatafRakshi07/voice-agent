...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 flex flex-col glass border-r border-white/[0.07]">
      ...
      <div className="px-5 pt-6 pb-5 border-b border-white/[0.05]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-white leading-tight grad-text">
              VoiceAgent
            </p>
            <p className="text-[10px] text-slate-500 font-medium tracking-[0.12em] uppercase mt-0.5">
              Self-Hosted AI
            </p>
          </div>
        </div>
          ...
          return (
            <Link
              ...
              className={`group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${
                active
                  ? "nav-active text-indigo-200 bg-gradient-to-r from-indigo-950/60 to-transparent"
      ...
      <div className="px-4 py-4">
        <div className="icon-emerald-pill flex items-center gap-2.5 px-3 py-2.5 rounded-xl">
          ...
          <span className="ml-auto text-[10px] text-slate-600 font-mono">v1.0</span>
        </div>
      </div>
    </aside>
  );
